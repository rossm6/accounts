...
class CreateBroughtForwardReceipt(TestCase):
    ...
    def test_get_request_with_query_params(self):
        ...
        response = self.client.get(reverse("cashbook:create") + "?t=cbr")
        ...
        self.assertContains(
            ...
            '<option value="cbr" selected>Brought Forward Receipt</option>'
...
class EditBroughtForwardReceipt(TestCase):
