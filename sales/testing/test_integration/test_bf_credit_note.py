...
class CreateBroughtForwardCreditNoteNominalTransactions(TestCase):
    ...
    # CORRECT USAGE
    def test_zero_brought_forward_credit_note_with_no_analysis_but_matching_tran(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
    ...
    # INCORRECT USAGE
    def test_zero_brought_forward_credit_note_with_zero_value_line(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
    ...
    # CORRECT USAGE
    def test_fully_matching_a_bf_credit_note(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
    ...
    # CORRECT USAGE
    def test_negative_bf_credit_note_entered_without_matching(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
    ...
    # CORRECT USAGE
    def test_negative_bf_credit_note_without_matching_with_total(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
    ...
    # CORRECT USAGE
    def test_fully_matching_a_negative_bf_credit_note_NEGATIVE(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
    ...
    # CORRECT USAGE
    def test_selecting_a_transaction_to_match_but_for_zero_value_against_negative_bf_credit_note_NEGATIVE(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
    ...
    # INCORRECT USAGE
    # Try and match -2400.01 to an invoice for 2400
    def test_match_total_less_than_bf_credit_note_total_NEGATIVE(self):
        self.client.force_login(self.user)
        data = {}
        header_data = create_header(
            HEADER_FORM_PREFIX,
...
class EditBroughtForwardCreditNoteNominalEntries(TestCase):
    ...
    def test_non_zero_brought_forward_credit_note_is_changed_to_zero_value_by_deleting_all_lines(self):
        self.client.force_login(self.user)
        header, lines = create_credit_note_with_lines(
            {
                "type": "sbc",
    ...
    # CORRECT USAGE
    def test_change_zero_brought_forward_credit_note_to_a_non_zero_invoice(self):
        self.client.force_login(self.user)
