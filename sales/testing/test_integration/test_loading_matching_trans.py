...
from sales.models import Customer, SaleHeader, SaleMatching
...
class LoadingMatchingTransactions(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse("sales:load_matching_transactions")
    ...
    def test_already_matched_are_excluded(self):
        ...
        matching_header = SaleHeader.objects.create(
            type="pi",
            customer=self.customer,
            ref="1",
            period=self.period,
        ...
        match = SaleMatching.objects.create(
            matched_by=header,
